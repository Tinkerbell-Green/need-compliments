...
export type State = {
  ...
  [DataActionType.GET_PUBLIC_TASKS]: Record<string, DataSagaState & {data: TaskData[] | undefined, payload:DataActionPayload[DataActionType.GET_PUBLIC_TASKS]}>,
  ...
  [DataActionType.GET_GOALS_BY_IDS]: Record<string, DataSagaState & {data: GoalData[] | undefined, payload:DataActionPayload[DataActionType.GET_GOALS]}>,
